...
document.addEventListener('DOMContentLoaded', () => {
          ...
          <div class="game-card-image-wrap">
            ...
            <div class="game-card-title-wrap">
              ...
              <div style="display:flex; align-items:center; gap:0.25rem; color:#facc15; margin-top:0.1rem;">
                ...
                <span style="color:white; font-size:0.75rem; font-weight:700; opacity:0.9;">4.0</span>
              </div>
            </div>
          </div>
  ...
  // Auth form submit — mark as logged in
  ...
  if (authForm) {
    authForm.addEventListener('submit', (e) => {
      ...
      // Update profile icon to blue to indicate logged in
      if (authBtn) {
        authBtn.style.backgroundColor = '#eff6ff';
