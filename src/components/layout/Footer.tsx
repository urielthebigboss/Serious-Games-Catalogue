      ...
      <div className="max-w-7xl mx-auto grid grid-cols-3 gap-8">
        ...
        <div>
          ...
          <nav className="space-y-3">
            ...
            <a href="/add" className="flex items-center gap-3 text-white hover:text-gray-300 transition-colors">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="/about" className="flex items-center gap-3 text-white hover:text-gray-300 transition-colors">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <circle cx="12" cy="12" r="10" strokeWidth={2} />
            ...
            <a href="/profile" className="flex items-center gap-3 text-white hover:text-gray-300 transition-colors">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
